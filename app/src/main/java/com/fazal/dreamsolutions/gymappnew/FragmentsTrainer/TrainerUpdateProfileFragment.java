...
import com.fazal.dreamsolutions.gymappnew.Objects.Available;
import com.fazal.dreamsolutions.gymappnew.Objects.ModelCreateProfile;
...
public class TrainerUpdateProfileFragment extends Fragment {
    ...
    private void apiCallName(final String Name) {
        RequestQueue requestQueue = Volley.newRequestQueue(getActivity());
        String URL = GeneralUtils.URL + "api/ManageAccount/" + myApplication.getLoginSession().getToken().getEmail() + "/" + Name + "/ChangeName";
