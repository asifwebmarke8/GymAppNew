...
import com.fazal.dreamsolutions.gymappnew.Activities.PaymentActivity;
...
public class TrainerDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        available_hours.setText(modelNearByTrainers.getAvailable().getAvailableTo() + "-" + modelNearByTrainers.getAvailable().getAvailableTo());
