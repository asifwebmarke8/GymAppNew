...
class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ViewHolder> {
    ...
    private List<com.fazal.dreamsolutions.gymappnew.Objects.Chat> mDataSet;
    private String mId;

    ChatAdapter(List<com.fazal.dreamsolutions.gymappnew.Objects.Chat> dataSet, String id, Context context) {
        mDataSet = dataSet;
        mId = id;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        com.fazal.dreamsolutions.gymappnew.Objects.Chat chat = mDataSet.get(position);
